...
//sayinin her bir basamagini kontrol et
...
//toplam girilen sayiya esitse armstrong sayisidir
if (sum == number) {
...
function isArmstrongNumber(num) {
  //Sayinin orjinalini saklayalim 1453
  ...
  while (orjinalNumber !== 0) {
    ...
    digitCount++; //her bölmede sayiyi artırdık
  }
  // Orjinal sayiya geri dönelim:
  orjinalNumber = num;
  //sayinin her bir basamagini alip basamak sayisina göre üssünü alip toplayalım
  while (orjinalNumber > 0) {
    let digit = orjinalNumber % 10; //son basamagi bulduk
    sum += digit ** digitCount; //Basamagin digitCount kadar üssüne ekle
    orjinalNumber = Math.floor(orjinalNumber / 10); //sayıyı bir basamak eksilt
  }
